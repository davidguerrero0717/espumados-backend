      ...
      <div class="modal-body">
        <form method="POST">
          <div class="mb-3">
            ...
            <input type="text" class="form-control" id="nombreInput" name="nombre" aria-describedby="nombreHelp">
          </div>
          <div class="mb-3">
            <label for="nombrePantallaInput" class="form-label">Nombre en pantalla</label>
            <input type="text" class="form-control" id="nombrePantallaInput" name="nombrePantalla">
          </div>
          <div class="mb-3">
